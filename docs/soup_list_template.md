...
| {{ item.ID }} | {{ item['Software System'] }} | {{ item['Package Name'] }} | {{ item['Programming Language'] }} | {{ item['Version'] }} | [{{ item['Website'] }}]({{ item['Website'] }}) | {{ item['Last verified at'] }} | {{ item['Risk Level'] }} | {{ item['Requirements'] }} | {{ item['Verification Reasoning'] }}
{% endfor %}
